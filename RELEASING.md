...
How to cut a new version of Onboarding Compass.
...
4. Tag the release commit and push both:
   ...
   ```
5. Verify the deploy on whichever platform hosts this project (Vercel / Netlify / etc.).

## Rolling back production

**Preferred — platform one-click:** Dashboard → Deployments → find the deployment whose commit SHA matches the previous tag → "Promote to Production" (Vercel) or equivalent. Instant, no rebuild.
